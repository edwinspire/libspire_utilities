/* libspire_gsm.h generated by valac 0.12.0, the Vala compiler, do not modify */


#ifndef __R__OPERADORES_EDWINDLC_PROGRAMACION_PROYECTOSSOFTWARE_SOFTWARE_VALA_PROYECTOSVALA_PROYECTS_LIBSPIRE_GSM_BIN_WIN_LIBSPIRE_GSM_H__
#define __R__OPERADORES_EDWINDLC_PROGRAMACION_PROYECTOSSOFTWARE_SOFTWARE_VALA_PROYECTOSVALA_PROYECTS_LIBSPIRE_GSM_BIN_WIN_LIBSPIRE_GSM_H__
...
#define EDWINSPIRE_GSM_MODEM_TYPE_CME (edwinspire_gsm_modem_cme_get_type ())
...
typedef enum  {
	EDWINSPIRE_GSM_MODEM_PHONE_ACTIVITY_STATUS_Ready,
	EDWINSPIRE_GSM_MODEM_PHONE_ACTIVITY_STATUS_Unavailable,
	EDWINSPIRE_GSM_MODEM_PHONE_ACTIVITY_STATUS_Unknown,
	EDWINSPIRE_GSM_MODEM_PHONE_ACTIVITY_STATUS_Ringing,
	EDWINSPIRE_GSM_MODEM_PHONE_ACTIVITY_STATUS_Call,
	EDWINSPIRE_GSM_MODEM_PHONE_ACTIVITY_STATUS_Asleep,
...
typedef enum  {
	EDWINSPIRE_GSM_MODEM_MODEM_MODEL_General,
	EDWINSPIRE_GSM_MODEM_MODEM_MODEL_Motorola,
	EDWINSPIRE_GSM_MODEM_MODEM_MODEL_TVMobile
} edwinspireGSMMODEMModemModel;

typedef enum  {
	EDWINSPIRE_GSM_MODEM_CME_PhoneFailure = 0,
	EDWINSPIRE_GSM_MODEM_CME_NoConnectionToPhone = 1,
	EDWINSPIRE_GSM_MODEM_CME_PhoneAdaptorLinkReserved = 2,
	EDWINSPIRE_GSM_MODEM_CME_OperationNotAllowed = 3,
	EDWINSPIRE_GSM_MODEM_CME_OperationNotSupported = 4,
	EDWINSPIRE_GSM_MODEM_CME_PH_SIM_PIN_Required = 5,
	EDWINSPIRE_GSM_MODEM_CME_PH_FSIM_PIN_Rrequired = 6,
	EDWINSPIRE_GSM_MODEM_CME_PH_FSIM_PUK_Required = 7,
	EDWINSPIRE_GSM_MODEM_CME_SIM_NotInserted = 10,
	EDWINSPIRE_GSM_MODEM_CME_SIM_PIN_Required = 11,
	EDWINSPIRE_GSM_MODEM_CME_SIM_PUK_Required = 12,
	EDWINSPIRE_GSM_MODEM_CME_SIM_Failure = 13,
	EDWINSPIRE_GSM_MODEM_CME_SIM_Busy = 14,
	EDWINSPIRE_GSM_MODEM_CME_SIM_Wrong = 15,
	EDWINSPIRE_GSM_MODEM_CME_IncorrectPassword = 16,
	EDWINSPIRE_GSM_MODEM_CME_SIM_PIN2_Required = 17,
	EDWINSPIRE_GSM_MODEM_CME_SIM_PUK2_Rrequired = 18,
	EDWINSPIRE_GSM_MODEM_CME_MemoryFull = 20,
	EDWINSPIRE_GSM_MODEM_CME_InvalidIndex = 21,
	EDWINSPIRE_GSM_MODEM_CME_NotFound = 22,
	EDWINSPIRE_GSM_MODEM_CME_MemoryFailure = 23,
	EDWINSPIRE_GSM_MODEM_CME_TextStringTooLong = 24,
	EDWINSPIRE_GSM_MODEM_CME_InvalidCharactersInTextString = 25,
	EDWINSPIRE_GSM_MODEM_CME_DialStringTooLong = 26,
	EDWINSPIRE_GSM_MODEM_CME_InvalidCharactersInDialString = 27,
	EDWINSPIRE_GSM_MODEM_CME_NoNetworkService = 30,
	EDWINSPIRE_GSM_MODEM_CME_NetworkTimeout = 31,
	EDWINSPIRE_GSM_MODEM_CME_EmergencyCallsOnly = 32,
	EDWINSPIRE_GSM_MODEM_CME_NetworkPersonalizationPIN_Required = 40,
	EDWINSPIRE_GSM_MODEM_CME_NetworkPersonalization_PUK_Required = 41,
	EDWINSPIRE_GSM_MODEM_CME_NetworkSubsetPersonalization_PIN_Required = 42,
	EDWINSPIRE_GSM_MODEM_CME_NetworkSubsetPersonalization_PUK_Required = 43,
	EDWINSPIRE_GSM_MODEM_CME_ServiceProviderPersonalization_PIN_Required = 44,
	EDWINSPIRE_GSM_MODEM_CME_ServiceProviderPersonalization_PUK_Required = 45,
	EDWINSPIRE_GSM_MODEM_CME_CorporatePersonalization_PIN_Required = 46,
	EDWINSPIRE_GSM_MODEM_CME_CorporatePersonalization_PUK_Required = 47,
	EDWINSPIRE_GSM_MODEM_CME_Unknown = 100
} edwinspireGSMMODEMCME;
...
typedef enum  {
	...
	EDWINSPIRE_GSM_MODEM_SMS_STATUS_UNKNOW
...
typedef enum  {
	EDWINSPIRE_GSM_MODEM_CHAR_SET_Unknow,
...
typedef enum  {
	...
	EDWINSPIRE_GSM_MODEM_MODE_UNKNOW
...
GType edwinspire_gsm_modem_cme_get_type (void) G_GNUC_CONST;
...
void edwinspire_gsm_modem_modem_gsm_Features (edwinspireGSMMODEMModemGSM* self);
...
gboolean edwinspire_gsm_modem_modem_gsm_DeleteMessage (edwinspireGSMMODEMModemGSM* self, gint msg_reference);
gboolean edwinspire_gsm_modem_modem_gsm_CMGD (edwinspireGSMMODEMModemGSM* self, gint MessageReference);
